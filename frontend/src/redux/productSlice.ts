...
// export const editProduct = createAsyncThunk<Product, ProductFormData & { id: number }>(
//     "products/editProduct",
//     async (updatedProduct) => {
//         const response = await axios.put(
//             `${process.env.NEXT_PUBLIC_BASE_URL}/api/product/${updatedProduct.id}`,
//             updatedProduct,
//             { withCredentials: true }
//         );
...
export interface ProductFormData {
    ...
    productName: string;
    image: string;
    status?: string; // Added status as optional for editing
}
