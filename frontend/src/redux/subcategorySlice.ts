...
// export const editSubcategory = createAsyncThunk<Subcategory, SubcategoryFormData & { id: number }>(
//     "subcategories/editSubcategory",
//     async (updatedSubcategory) => {
//         const response = await axios.put(
//             `${process.env.NEXT_PUBLIC_BASE_URL}/api/subcategory/${updatedSubcategory.id}`,
//             updatedSubcategory,
//             { withCredentials: true }
//         );
...
//     async (subcategoryId) => {
//         await axios.delete(
//             `${process.env.NEXT_PUBLIC_BASE_URL}/api/subcategory/${subcategoryId}`,
//             { withCredentials: true }
//         );
